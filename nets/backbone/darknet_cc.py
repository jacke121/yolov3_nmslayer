...
#         # self.conv1 = CoordConv(planes[0],planes[0],False,inplanes, planes[0], kernel_size=1,stride=1, padding=0, bias=False)
#
#
#         self.bn1 = nn.BatchNorm2d(planes[0])
#         self.relu1 = nn.LeakyReLU(0.1)
#         # self.conv2 = nn.Conv2d(planes[0], planes[1], kernel_size=3,stride=1, padding=1, bias=False)
#         self.conv2 = CoordConv(dim,dim,False,planes[0]+2, planes[1], kernel_size=3,stride=1, padding=1, bias=False)
#         # self.conv2 = CoordConv(planes[0],planes[0],False,planes[0], planes[1], kernel_size=3,stride=1, padding=1, bias=False)
...
#         self.conv1 =CoordConv(416,416,False,3+2,self.inplanes, kernel_size=3,stride=1, padding=1, bias=False)
...
#         layers.append(("ds_conv",CoordConv(dim,dim,False,self.inplanes+2, planes[1], kernel_size=3,stride=2, padding=1, bias=False)))
