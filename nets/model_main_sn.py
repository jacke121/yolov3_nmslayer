...
#             ("bn", switch_norm.SwitchNorm(_out, using_moving_average=True,last_gamma=True)),
#             ("relu", nn.LeakyReLU(0.1)),
#         ]))
#
#     def _make_embedding(self, filters_list, in_filters, out_filter):
#         m = nn.ModuleList([
#             self._make_cbl(in_filters, filters_list[0], 1,last_gamma=True),
#             self._make_cbl(filters_list[0], filters_list[1], 3,last_gamma=True),
#             self._make_cbl(filters_list[1], filters_list[0], 1,last_gamma=True),
#             self._make_cbl(filters_list[0], filters_list[1], 3,last_gamma=True),
#             self._make_cbl(filters_list[1], filters_list[0], 1,last_gamma=True),
#             self._make_cbl(filters_list[0], filters_list[1], 3,last_gamma=True)])
